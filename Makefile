...
quality: ## check coding style with pycodestyle and pylint
	...
	pylint social_auth_backend_docebo tests test_utils *.py
	rm tests/__init__.py
	pycodestyle social_auth_backend_docebo tests  *.py
	pydocstyle social_auth_backend_docebo tests *.py
	isort --check-only --diff --recursive tests test_utils social_auth_backend_docebo *.py test_settings.py
	make selfcheck
