...
"""
social-auth-backend-docebo documentation build configuration file.
...
VERSION = get_version('../social-auth-backend-docebo', '__init__.py')
...
project = 'social-auth-backend-docebo'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'social-auth-backend-docebo'
...
#
# html_title = 'social-auth-backend-docebo v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Docebo backend for Social Auth',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'social_auth_backend_docebo'),
                os.path.join(root_path, 'social_auth_backend_docebo/migrations')])
